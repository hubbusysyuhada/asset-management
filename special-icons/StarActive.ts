class StarActive extends HTMLElement {
...
<path d="M8.95801 8.36523L11.958 2.86523L14.958 8.36523L20.958 9.36523L16.958 13.8652L17.458 19.8652L11.958 17.8652L6.45801 19.8652L6.95801 13.8652L2.95801 9.36523L8.95801 8.36523Z" fill="#FFD740"/>
...
`
  ...
  _setState() {
    // @ts-ignore
    this.props.forEach(key => this[key as keyof typeof StarActive] = this.getAttribute(key));
  }
}
