class HomeActive extends HTMLElement {
...
`
  ...
  _setState() {
    // @ts-ignore
    this.props.forEach(key => this[key as keyof typeof HomeActive] = this.getAttribute(key));
  }
}
