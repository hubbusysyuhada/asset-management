class DuniaDisabled extends HTMLElement {
...
<path d="M21.9993 11.9994C21.9993 6.47675 17.5223 1.99976 11.9996 1.99976C6.47699 1.99976 2 6.47675 2 11.9994C2 17.522 6.47699 21.999 11.9996 21.999C17.5223 21.999 21.9993 17.522 21.9993 11.9994Z" stroke="#B7B6B7" stroke-width="1.7142" stroke-miterlimit="10"/>
...
`
  ...
  _setState() {
    // @ts-ignore
    this.props.forEach(key => this[key as keyof typeof DuniaDisabled] = this.getAttribute(key));
  }
}
export default DuniaDisabled