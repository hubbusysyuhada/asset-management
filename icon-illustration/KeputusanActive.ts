class KeputusanActive extends HTMLElement {
...
`
  ...
  _setState() {
    // @ts-ignore
    this.props.forEach(key => this[key as keyof typeof KeputusanActive] = this.getAttribute(key));
  }
}
export default KeputusanActive