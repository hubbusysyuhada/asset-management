class AdministratorDefault extends HTMLElement {
...
<path d="M100.963 114H27.9256C25.2067 114 23 111.794 23 109.075V106.445C23 83.2448 41.9834 63.8674 65.183 64.2713C87.703 64.6654 105.888 83.1069 105.888 105.706V109.065C105.888 111.794 103.682 114 100.963 114Z" fill="#989899"/>
...
`
  ...
  _setState() {
    // @ts-ignore
    this.props.forEach(key => this[key as keyof typeof AdministratorDefault] = this.getAttribute(key));
  }
}
export default AdministratorDefault