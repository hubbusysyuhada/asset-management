class Wallet extends HTMLElement {
...
`
  ...
  _setState() {
    // @ts-ignore
    this.props.forEach(key => this[key as keyof typeof Wallet] = this.getAttribute(key));
  }
}
