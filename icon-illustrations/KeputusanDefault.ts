class KeputusanDefault extends HTMLElement {
...
`
  ...
  _setState() {
    // @ts-ignore
    this.props.forEach(key => this[key as keyof typeof KeputusanDefault] = this.getAttribute(key));
  }
}
export default KeputusanDefault