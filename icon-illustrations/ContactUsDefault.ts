class ContactUsDefault extends HTMLElement {
...
`
  ...
  _setState() {
    // @ts-ignore
    this.props.forEach(key => this[key as keyof typeof ContactUsDefault] = this.getAttribute(key));
  }
}
