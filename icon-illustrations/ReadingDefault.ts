class ReadingDefault extends HTMLElement {
...
`
  ...
  _setState() {
    // @ts-ignore
    this.props.forEach(key => this[key as keyof typeof ReadingDefault] = this.getAttribute(key));
  }
}
export default ReadingDefault