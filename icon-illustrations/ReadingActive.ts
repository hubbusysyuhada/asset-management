class ReadingActive extends HTMLElement {
...
`
  ...
  _setState() {
    // @ts-ignore
    this.props.forEach(key => this[key as keyof typeof ReadingActive] = this.getAttribute(key));
  }
}
export default ReadingActive